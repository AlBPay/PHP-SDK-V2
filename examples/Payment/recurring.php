...
try {
    //Generating pcidss order to get payment token see more https://documentation.albpay.io/docs/page/4/
    $TestOrderData = [
        'order_id' => time(),
    ...
    // Required params see more https://documentation.albpay.io/docs/page/10/
